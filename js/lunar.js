...
const lunarHolidaysList2 = [
  "<a href=\"10_laba.html\">Праздник Лаба</a> (腊八节)",
  "<a href=\"11_xiaonian.html\">Малый Новый год</a> (小年)",
  "<a href=\"01_chunjie.html\">Китайский новый год</a> (春节)",
  "<a href=\"02_yuanxiao.html\">Праздник фонарей</a> (元宵节)",
  "<a href=\"03_eryueer.html\">Праздник двойной двойки</a> (二月二)",
  "<a href=\"04_sanyuesan.html\">Праздник двойной тройки</a> (三月三)",
  "<a href=\"05_duanwu.html\">Праздник драконьих лодок</a> (端午节)",
  "<a href=\"06_qixi.html\">Праздник Циси</a> (七夕节)",
  "<a href=\"07_zhongyuan.html\">Праздник голодных духов</a> (中元节)",
  "<a href=\"08_zhongqiu.html\">Праздник середины осени</a> (中秋节)",
  "<a href=\"09_chongjiu.html\">Праздник двойной девятки</a> (重九节)",
];
const solarTerm = [
...
function Solar2Lunar(yea, mx, dx) {
  ...
  dz = Math.floor(jdx) - Math.floor(sjd[mi] + 0.5) + 1;
  if (mc[mi] < 2 || flag == 1) {
    yi = yea - 1
  } else {
    yi = yea;
  ...
  mis = (Math.floor(mc[mi] + 10) % 12) + 1;

  if (mis == 1 && dz == 1) { lunarHoliday = 1; }
  else if (mis == 1 && dz == 15) { lunarHoliday = 2; }
  else if (mis == 2 && dz == 2) { lunarHoliday = 3; }
  else if (mis == 3 && dz == 3) { lunarHoliday = 4; }
  else if (mis == 5 && dz == 5) { lunarHoliday = 5; }
  else if (mis == 7 && dz == 7) { lunarHoliday = 6; }
  else if (mis == 7 && dz == 15) { lunarHoliday = 7; }
  else if (mis == 8 && dz == 15) { lunarHoliday = 8; }
  else if (mis == 9 && dz == 9) { lunarHoliday = 9; }
  else if (mis == 12 && dz == 8) { lunarHoliday = 10; }
  else if (mis == 12 && dz == 23) { lunarHoliday = 11; }
  else { lunarHoliday = 0; }
  out += yi + " год, " + dz + " день " + ry + mis + " лунного месяца" + "\n";
  return out;
}
